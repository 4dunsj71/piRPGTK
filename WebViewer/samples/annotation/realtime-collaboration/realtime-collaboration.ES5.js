!(function(t) {
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var x, S = '', w = 0, _ = 0; _ < m.length; _++) {
            b = m[_];
            for (var E = String(b[0]), O = a(s(u(b.index), h.length), 0), P = [], A = 1; A < b.length; A++) P.push(void 0 === (x = b[A]) ? x : String(x));
            var F = b.groups;
            if (p) {
              var I = [E].concat(P, O, h);
              void 0 !== F && I.push(F);
              var M = String(n.apply(void 0, I));
            } else M = y(E, h, O, P, F, n);
  ...
  function(t, n) {
    ...
    WebViewer(
      ...
      if ((t.openElements(['notesPanel']), 'http://localhost:3000' === window.location.origin)) {
        var c = new XMLHttpRequest();
        (c.onreadystatechange = function() {
          4 === c.readyState && 200 === c.status && (i.value = 'http://'.concat(c.responseText, ':3000/samples/annotation/realtime-collaboration/'));
        }),
          c.open('GET', '/ip', !0),
          c.send();
      ...
      (u.onclick = function() {
        ...
        n.on('documentLoaded', function() {
          var t = null,
            ...
            c = function(t) {
              r.setCurrentUser(t), window.alert('Welcome back '.concat(t));
            },
            f = function() {
              var n,
          ...
          o.bind('onAuthStateChanged', function(r) {
            r ? ((t = r.uid), o.checkAuthor(t, c, f), o.bind('onAnnotationCreated', n), o.bind('onAnnotationUpdated', i), o.bind('onAnnotationDeleted', u)) : o.signInAnonymously();
          }),
            r.on(
              'annotationChanged',
              (function() {
                          ...
                          case 4:
                            (c = n.sent),
                              e.forEach(function(n) {
                                var e = null;
                                'add' === i
                                  ? (n.InReplyTo && (e = r.getAnnotationById(n.InReplyTo).authorId || 'default'), o.createAnnotation(n.Id, { authorId: t, parentAuthorId: e, xfdf: c }))
                                  : 'modify' === i
